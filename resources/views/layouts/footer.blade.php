            ...
            <div class="footer__nav">
                <div class="footer__menu">
                    ...
                    <ul class="footer__list clear-list">
                        <li class="footer__item"><a href="./services.php" class="footer__link">Услуги</a></li>
                        <li class="footer__item"><a href="./carpark.php" class="footer__link">Автопарк</a></li>
                        <li class="footer__item"><a href="./about.php" class="footer__link">О нас</a></li>
                        <li class="footer__item"><a href="./projects.php" class="footer__link">Проекты</a></li>
                        <li class="footer__item"><a href="./contacts.php" class="footer__link">Контакты</a></li>
                    </ul>
                </div>
                <div class="footer__menu">
